...
class App extends React.Component {
  ...
  async createCats(newCatObj) {
    try {
      const response = await axios.post(`${SERVER}/cats`, newCatObj);
      ...
      <>
        <Router>
          ...
          <Switch>
            ...
            <Route exact path="/">
              <div>
                <Cats cats={this.state.cats} onDelete={this.deleteCat} />
            ...
            {/* NEW */}
            <Route path="/create">
              <CreateCat onCreate={this.createCats} />
            </Route>
          </Switch>
        </Router>
      </>
